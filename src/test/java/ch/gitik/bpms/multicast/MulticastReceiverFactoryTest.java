...
public class MulticastReceiverFactoryTest {
   ...
   public void testGetReceiver() {
      try {
         MulticastReceiver receiver1 = MulticastReceiverFactory.getReceiver(new MulticastConfig("1.1.1.1",
               PORT_1000));
         MulticastReceiver receiver2 = MulticastReceiverFactory.getReceiver(new MulticastConfig("2.2.2.2",
               PORT_1000));
         MulticastReceiver receiver3 = MulticastReceiverFactory.getReceiver(new MulticastConfig("1.1.1.1",
               PORT_1000));
         MulticastReceiver receiver4 = MulticastReceiverFactory.getReceiver(new MulticastConfig("2.2.2.2",
               PORT_1000));
